...
public class WeekDayView extends View {
	//上横线颜色
	private int mTopLineColor = Color.parseColor("#ff999db1");
	//下横线颜色
	private int mBottomLineColor = Color.parseColor("#ff999db1");
	//周一到周五的颜色
	private int mWeedayColor = Color.parseColor("#ff999db1");
	//周六、周日的颜色
	private int mWeekendColor = Color.parseColor("#ff999db1");
	//线的宽度
