    ...
    * */
    ...
    private void init(Context context, AttributeSet attrs) {
         ...
         */
         ...
         left_width = (int) typedArray.getDimension(R.styleable.UserPhoneEditText_user_left_width, ArmsUtils.dip2px(context,16));
         left_height = (int) typedArray.getDimension(R.styleable.UserPhoneEditText_user_left_height, ArmsUtils.dip2px(context,16));
