...
public class ZoomIndicator extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    public ZoomIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.PublicZoomIndicator);
        mSelector = ta.getResourceId(R.styleable.PublicZoomIndicator_public_zoom_dot,
                R.drawable.public_page_bottom_circle);
        mLeftMargin = (int) ta.getDimension(R.styleable.PublicZoomIndicator_public_zoom_leftmargin,15);
        mAlpha_min = ta.getFloat(R.styleable.PublicZoomIndicator_public_zoom_alpha_min,1f);
        mScale_max = ta.getFloat(R.styleable.PublicZoomIndicator_public_zoom_max,1.0f);
        mDismissOpen = ta.getBoolean(R.styleable.PublicZoomIndicator_public_zoom_dismiss_open,false);
    ...
    public void addPagerData(View view, int length, ViewPager viewPager) {
