 ...
 */
public class ic_arrow_right extends SVGRenderer {

    public ic_arrow_right(Context context) {
        super(context);
        mAlpha = 1.0f;
        mWidth = dip2px(16.0f);
    ...
    public void render(Canvas canvas, int w, int h, ColorFilter filter) {
        ...
        mPath.rLineTo(5.75f, 5.5f);
        mPath.rLineTo(-5.75f, 5.5f);
        mPath.rLineTo(1.0f, 1.0f);
        mPath.rLineTo(7.0f, -6.5f);
        mPath.close();
        mPath.moveTo(7.0f, 2.0f);
        ...
        mFillPaint.setColor(applyAlpha(-3420712, 1.0f));
