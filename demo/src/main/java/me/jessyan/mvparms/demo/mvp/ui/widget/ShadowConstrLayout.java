...
public class ShadowConstrLayout extends ConstraintLayout {
    /**
     * 画笔，这里设置阴影
     */
    ...
    public ShadowConstrLayout(Context context) {
        this(context, null);


    }

    public ShadowConstrLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
