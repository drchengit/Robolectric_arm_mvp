...
public class CustomPopupWindow extends PopupWindow {
    ...
    private CustomPopupWindow(Builder builder) {
        ...
        this.isWithMatch = builder.isWithMatch;
    ...
    private void initLayout() {
        ...
        setWidth(isWrap ? isWithMatch? LayoutParams.MATCH_PARENT: LayoutParams.WRAP_CONTENT : LayoutParams.MATCH_PARENT);
...
public Builder isWithMatch(boolean isWithMatch){
            this.isWithMatch = isWithMatch;
            return this;
}
        ...
        public  Builder defultHeight(int defultHeight){
