    ...
    private void setState(int state) {
        ...
        switch (state) {
            case STATE_NORMAL:
                ...
                msg.setText(R.string.xrecycler_listview_header_hint_normal);
                break;
            case STATE_RELEASE_TO_REFRESH:
                if (mState != STATE_RELEASE_TO_REFRESH) {
                    ...
                    msg.setText(R.string.xrecycler_listview_header_hint_release);
                }
                break;
            case STATE_REFRESHING:
                msg.setText(R.string.xrecycler_refreshing);
                break;
            case STATE_DONE:
                msg.setText(R.string.xrecycler_refresh_done);
                break;
            default:
        }
        mState = state;
