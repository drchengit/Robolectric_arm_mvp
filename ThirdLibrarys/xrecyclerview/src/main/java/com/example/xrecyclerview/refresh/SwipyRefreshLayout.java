...
package com.example.xrecyclerview.refresh;
...
import static com.example.xrecyclerview.refresh.SwipyRefreshLayoutDirection.BOTTOM;
...
public class SwipyRefreshLayout extends ViewGroup {
    ...
    //这个是一个距离，超过这个距离view 算触发了
    private float mTotalDragDistance = -1;
    private float mBottomDragDistance = 50;
    ...
    public SwipyRefreshLayout(Context context, AttributeSet attrs) {
        ...
        final TypedArray a2 = context.obtainStyledAttributes(attrs, R.styleable.xrecycler_SwipyRefreshLayout);
        SwipyRefreshLayoutDirection direction
                = SwipyRefreshLayoutDirection.getFromInt(a2.getInt(R.styleable.xrecycler_SwipyRefreshLayout_xrecycler_srl_direction, 0));
        ...
        setColorSchemeResources(R.color.XrecyclerF66440);
    }
        ...
        try {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_MOVE: {
                    ...
                    if (mIsBeingDragged&&mDirection== SwipyRefreshLayoutDirection.TOP) {
                        ...
                        setTargetOffsetTopAndBottom(targetY - mCurrentTargetOffsetTop,
                                true /* requires update */);
                    }else if(mDirection==BOTTOM&&mIsBeingDragged){//上拉加载
                        float originalDragPercent = overscrollTop / mBottomDragDistance;
                        if (originalDragPercent < 0) {
                            return false;
                        }

                        if (overscrollTop < mBottomDragDistance) {
